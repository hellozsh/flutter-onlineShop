class CategoryDetailRes {
  ...
  CategoryDetailRes({this.code, this.message, this.data});

  CategoryDetailRes.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new CategoryDetail.fromJson(json['data']) : null;
  }
...
class CategoryDetail {
  ...
  CategoryDetail({this.goodInfo, this.goodComments, this.advertesPicture});
